...
if FOAM_REF_VERSION( "==", "010600" ):
    from scalarTransportFlux.r1_6 import *
    pass


#----------------------------------------------------------------------------
if FOAM_BRANCH_VERSION( "dev", ">=", "010600" ):
    from scalarTransportFlux.r1_6_dev import *
    pass
   
   	
#--------------------------------------------------------------------------------------
if FOAM_REF_VERSION( "==", "010700" ) or FOAM_REF_VERSION( "==", "010701" ):
    from scalarTransportFlux.r1_7_0 import *
    pass


#--------------------------------------------------------------------------------------
if FOAM_REF_VERSION( "==", "020000" ) or FOAM_REF_VERSION( "==", "020001" ):
    from scalarTransportFlux.r2_0_0 import *
    pass


#--------------------------------------------------------------------------------------
if FOAM_REF_VERSION( ">=", "020100" ):
    from scalarTransportFlux.r2_1_0 import *
    pass
